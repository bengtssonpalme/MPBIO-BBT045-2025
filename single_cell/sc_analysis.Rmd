...
To see which genes have both statisticaly significant and biologicaly meaningfull change in expression level we can performe diferential expression analysis.
...
How many genes were signifficantly differentially expressed between the sampling times alone.
```{r}
