...
Make sure to check the console below for any answers R might ask from you.
Say "Yes" when it asks for confirmation and "a" when asking whether to update packages.
...
if (!require("SingleCellExperiment"))   # checks if the package exists and only install if not
...
ggplot() +
    geom_point(mapping = aes(x = V1, y = V2, color = as.factor(cancer_kclusters$cluster)))
```
