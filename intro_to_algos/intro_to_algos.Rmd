...
```{python}
print(temperatures[4])  # 1 atomic operation: getting the value
```
...
if (~gene_pos.has_key(query_gene):
...
Python is a procedural language that does play well with functions "play well" with the various
