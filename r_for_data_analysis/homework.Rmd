---
title: "Homework: Intro to R programming for data analysis"
date: "`r Sys.Date()`"
output:
  html_document:
    toc: true
...
In yeast, the rarest codon (besides stop codons) is `CGG` ([source](https://www.kazusa.or.jp/codon/cgi-bin/showcodon.cgi?species=4932)).
So, using table manipulation functions on the resulting table from a.,
create a column to count the occurrence of `GCC` per gene.
